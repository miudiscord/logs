...
client.on("unhandledGuildChannelUpdate", (oldChannel, newChannel) => {
  console.log("Channel '"+oldChannel.id+"' was edited but @gardena/logs couldn't find what was updated...");
});
...
client.on("unhandledGuildMemberUpdate", (oldMember, newMember) => {
  console.log("Member '"+oldMember.id+"' was edited but @gardena/logs couldn't find what was updated...");
});
...
client.on("unhandledGuildUpdate", (oldGuild, newGuild) => {
  console.log("Guild '"+oldGuild.id+"' was edited but @gardena/logs couldn't find what was updated...");
});
...
client.on("unhandledMessageUpdate", (oldMessage, newMessage) => {
  console.log("Message '"+oldMessage.id+"' was edited but @gardena/logs couldn't find what was updated...");
});
...
client.on("unhandledRoleUpdate", (oldRole, newRole) => {
  console.log("Role '"+oldRole.id+"' was updated but @gardena/logs couldn't find what was updated...");
});
...
client.on("unhandledUserUpdate", (oldUser, newUser) => {
  console.log("User '"+oldUser.id+"' was updated but @gardena/logs couldn't find what was updated...");
});
...
client.on("unhandledVoiceStateUpdate", (oldState, newState) => {
  console.log("Voice state for member '"+oldState.member.user.tag+"' was updated but @gardena/logs couldn't find what was updated...");
});
